...
\item identify core dimensions such as task selection, context provision, prompt understanding, failure anticipation, verification, usability, and ethical use;
\item document practical failure cases, such as incomplete context or placing AI at the wrong point in a decision workflow;
\item examine prompt robustness and generalization: whether useful results persist across reasonable variations in phrasing, users, and workflow conditions;
